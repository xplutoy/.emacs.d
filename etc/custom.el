...
;; Modified: <2024-02-04 23:31:29 yx>
;; Licence: GPLv3
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(bing-dict iedit pyim snap-indent surround goto-chg org-web-tools graphviz-dot-mode org-download lua-ts-mode symbol-overlay citar-embark lin haskell-mode quickrun editorconfig eshell-syntax-highlighting dwim-shell-command dape sideline-eldoc sideline-flymake sideline yasnippet-snippets yasnippet edit-indirect markdown-mode ef-themes mixed-pitch citre puni hungry-delete marginalia dirvish tldr git-modes breadcrumb breadcrumb-mode devdocs ws-butler tabspaces bug-hunter command-log-mode apheleia zoxide engine-mode burly helpful citar-denote denote org-project geiser-chez sis ace-link gnuplot-mode rainbow-mode drag-stuff ace-window elfeed-webkit elfeed olivetti pdf-tools vimrc-mode ess julia-snail eglot-jl julia-ts-mode julia-mode poetry pyvenv-auto pyvenv code-cells jupyter rainbow-delimiters hl-todo indent-guide aggressive-indent magit diff-hl tempel citar cdlatex auctex org-transclusion org-appear valign org-modern org-ql pcmpl-args popper zoom dired-collapse diredfl ibuffer-vc fanyi flyspell-correct jinx vundo easy-kill avy goggles which-key posframe no-littering gcmh key-chord cape corfu consult-eglot consult-dir embark-consult embark orderless vertico minions benchmark-init))
